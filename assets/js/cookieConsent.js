...
(function() {
  ...
  function updateConsent(prefs) {
    ...
    // Carregar Clarity se analytics foi aceito
  ...
  // ============================================================================
  // MICROSOFT CLARITY — SÓ CARREGA COM CONSENTIMENTO ANALYTICS
  // ============================================================================

  function loadClarity() {
    if (window.clarity) {
      console.log('[CookieConsent] Clarity já presente');
      return;
    }
    ...
    })(window, document, "clarity", "script", "vl7f9xnnqa");
    console.log('[CookieConsent] Clarity carregado');
  }
